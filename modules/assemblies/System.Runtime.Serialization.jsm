...
var EXPORTED_SYMBOLS = ["SerializationException"];

Components.utils.import( "resource://xulu/assemblies/System.jsm" );


function SerializationException( message, innerException )	{
	this.prototype = new System.Object( System.SystemException );
	System.SystemException.call( this, message, innerException );
	this.SetErrorCode( 0x8013150C );
};
